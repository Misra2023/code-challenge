...
if (speed <= speedLimit){
 console.log("OK") ;  
    ...
    demeritPoints - Math.floor((speed-
        speedLimit) / kmPerDemeritPoint);
        if (demeritPoints > 12) {
...
//QUESTION 3
// DefinING the tax,NHIF,and NSSF rates
(above 32333 basic salary)
const TAX_RATE = 0.25
...
//Calculating the tax, NHIF,and NSSF 
deduction
const taxDeduction = grossSalary*
TAX_RATE;
const nhifDeduction = grossSalary*
NHIF_RATE;
const nssfDeduction = grossSalary*
NSSF_RATE;
